...
- Uma página web que contém uma paleta de cores funcional que poderá ser utilizada para criar desenhos em pixels. Para isto utilizei `javascript puro (vanilla)`, `css` e `html`.
...
* Neste projeto, implementei um editor de arte com pixels.

**Ou seja, dada uma paleta de cores e um quadro composto por pixels, será possível pintar o que quiser no quadro!** 👩‍🎨

### 1 - Adicione à página uma paleta de quatro cores distintas.
...
### 3 - Adicione à página um quadro de pixels, com 25 pixels.
...
### 5 - Defina a cor preta como cor inicial. Ao carregar a página, a cor preta já deve estar selecionada para pintar os pixels
...
### 6 - Clicar em uma das cores da paleta faz com que ela seja selecionada e utilizada para preencher os pixels no quadro.
...
### 10 - Limite o tamanho mínimo e máximo do board.
...
### 11 - Faça com que as cores da paleta sejam geradas aleatoriamente ao carregar a página.
